...
local function show_ippopup_infos(n_graph)
  ...
  --dbg({data[n_graph][interface.."_state"]})
  if data[n_graph][interface.."_state"] == "up" or data[n_graph][interface.."_state"] == "unknown" then
	--dbg({data[n_graph][interface.."_carrier"]})	
    if data[n_graph][interface.."_carrier"] == "1" or data[n_graph][interface.."_carrier"] == "0" then --get local ip configuration
      ...
      local ext_ip = awful.util.pread("curl --silent --connect-timeout 7 -S " .. url_for_ext_ip .. " 2>&1")
